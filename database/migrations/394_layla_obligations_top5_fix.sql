-- Migration: 392_layla_dashboard_key_alignment_v2.sql
-- Unit: Layla Counsel QA Phase 3.7 — align dashboard fn keys to FE expectations
-- (`risk` not `riskExposure`; `regulatoryUpdates` not `regUpdates12w`;
--  `obligations` not `obligationsAtRisk`).
